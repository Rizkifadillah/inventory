        ...
        <div class="box box-warning">
            <div class="box-header">
                <p>
                    ...
                    <a href="{{ url('po/add')}}" class="btn btn-sm btn-flat btn-primary "><i class="fa fa-plus"></i> Tambah</a>
                </p>
            </div>
            <div class="box-body">
                    ...
                    <table class="table table-stripped myTable">
                        ...
                        @foreach($data as $e=>$dt)
                            <tr>
                                <td>{{$e+1}}</td>
                                <td>
                                    <a href="{{ url('po/detail/'.$dt->id)}}" id-produk="'.$id.'" class="btn btn-success btn-xs btn-edit" id="edit"><i class="fa fa-eye"></i></a>
                                    ...
                                    <a href="{{ url('po/approved/'.$dt->id)}}" class="btn "><i class="fa fa-download"></i></a>
