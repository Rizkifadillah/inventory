            ...
            <div class="box-body">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="document_no" value="{{$doc}}"class="form-control" id="exampleInputEmail1" placeholder="Nama Suppllier">
                </div>

                @if(isset($id_supplier))
                <div class="form-group">
                  <label for="exampleInputPassword1">Supplier</label>
                    <select class="form-control celect2" name="supplier" id="">
                ...
                <div class="col-md-12">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" value="{{ $pd->id}}" class="form-control" name="produk[]">
